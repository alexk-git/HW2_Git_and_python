...
✅ 1. Посмотрите состав своей команды здесь Самостоятельно выбирете тимлида в вашей команде. Распределите кто какую из 5-и функций будет писать.
...
Pull-request должен называться `HW2_<surname>`, содержать папку `HW2_<surname>` (со всем кодом) и идти из ветки `HW2_<surname> ` в `Python-BI-2025-26:main`. Проверьте что всё аналогично тому как на скриншоте!
...
- За правильную структуру форков как описано выше  - **10 баллов**
